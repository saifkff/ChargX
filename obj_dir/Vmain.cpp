...
//==========
CData/*1:0*/ Vmain::__Vtable1_top__DOT__ex_sel_bit_mux[16];
CData/*2:0*/ Vmain::__Vtable2_top__DOT__wb_mux_sel[32];
...
VL_INLINE_OPT void Vmain::_combo__TOP__2(Vmain__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmain::_combo__TOP__2\n"); );
    Vmain* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->mux_select = vlTOPp->enable;
    vlTOPp->out = ((IData)(vlTOPp->select) ? vlTOPp->imm_input
                    : vlTOPp->reg_input);
}

void Vmain::_settle__TOP__3(Vmain__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmain::_settle__TOP__3\n"); );
    Vmain* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->mux_select = vlTOPp->enable;
    vlTOPp->out = ((IData)(vlTOPp->select) ? vlTOPp->imm_input
    ...
    if ((((IData)(vlTOPp->top__DOT__id_jalr) & ((IData)(vlTOPp->top__DOT__ex_rd) 
                                                == 
                                                (0x1fU 
                                                 & (vlTOPp->top__DOT__id_instruction 
                                                    >> 0xfU)))) 
    ...
    if ((1U & (~ (((IData)(vlTOPp->top__DOT__id_jalr) 
        ...
        if (vlTOPp->top__DOT__ex_branch_taken) {
            ...
            if ((0x6fU == (0x7fU & vlTOPp->top__DOT__id_instruction))) {
                vlTOPp->top__DOT__flush_for_if = 1U;
            }
        }
    }
...
VL_INLINE_OPT void Vmain::_sequent__TOP__4(Vmain__Syms* __restrict vlSymsp) {
    ...
    if (vlTOPp->rst) {
        vlTOPp->top__DOT__ex_mem__DOT__rs1_out = 0U;
    }
    ...
    vlTOPp->top__DOT__wb_mem_data = 0U;
    ...
    if (((IData)(vlTOPp->rst) | (IData)(vlTOPp->top__DOT__flush))) {
        ...
        if ((1U & (~ (IData)(vlTOPp->top__DOT__stall)))) {
            vlTOPp->top__DOT__ex_jal_enb = ((0x6fU 
                                             == (0x7fU 
                                                 & vlTOPp->top__DOT__id_instruction)) 
                                            | (IData)(vlTOPp->top__DOT__id_jalr));
        }
...
void Vmain::_initial__TOP__5(Vmain__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmain::_initial__TOP__5\n"); );
    Vmain* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
...
void Vmain::_ctor_var_reset() {
    ...
    top__DOT__forwarding_unit__DOT__clk = VL_RAND_RESET_I(1);
    top__DOT__ex_mem__DOT__rs1_out = VL_RAND_RESET_I(5);
    top__DOT__ex_mem__DOT__rs2_out = VL_RAND_RESET_I(5);
    __Vtableidx1 = 0;
    __Vtablechg1[0] = 0U;
    __Vtablechg1[1] = 1U;
    __Vtablechg1[2] = 1U;
    ...
    __Vtable1_top__DOT__ex_sel_bit_mux[3] = 0U;
    __Vtable1_top__DOT__ex_sel_bit_mux[4] = 1U;
    __Vtable1_top__DOT__ex_sel_bit_mux[5] = 0U;
    __Vtable1_top__DOT__ex_sel_bit_mux[6] = 0U;
    __Vtable1_top__DOT__ex_sel_bit_mux[7] = 0U;
    __Vtable1_top__DOT__ex_sel_bit_mux[8] = 0U;
    __Vtable1_top__DOT__ex_sel_bit_mux[9] = 0U;
    __Vtable1_top__DOT__ex_sel_bit_mux[10] = 0U;
    __Vtable1_top__DOT__ex_sel_bit_mux[11] = 0U;
    __Vtable1_top__DOT__ex_sel_bit_mux[12] = 0U;
    __Vtable1_top__DOT__ex_sel_bit_mux[13] = 0U;
    __Vtable1_top__DOT__ex_sel_bit_mux[14] = 0U;
    __Vtable1_top__DOT__ex_sel_bit_mux[15] = 0U;
    __Vtableidx2 = 0;
