...
VL_MODULE(Vtop) {
  public:
    ...
    struct {
        ...
        CData/*7:0*/ top__DOT__data_mem__DOT__memory[4097];
    };
    
    // LOCAL VARIABLES
    // Internals; generally not touched by application code
    CData/*3:0*/ top__DOT____Vcellinp__mux_rs2__sel_bit;
    CData/*7:0*/ top__DOT__data_mem__DOT____Vlvbound1;
    CData/*7:0*/ top__DOT__data_mem__DOT____Vlvbound2;
    CData/*7:0*/ top__DOT__data_mem__DOT____Vlvbound3;
    CData/*7:0*/ top__DOT__data_mem__DOT____Vlvbound4;
    CData/*7:0*/ top__DOT__data_mem__DOT____Vlvbound5;
    CData/*7:0*/ top__DOT__data_mem__DOT____Vlvbound6;
    CData/*7:0*/ top__DOT__data_mem__DOT____Vlvbound7;
